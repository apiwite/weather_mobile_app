...
WeatherApiDtails weatherApiDtailsFromJson(String str) =>
    WeatherApiDtails.fromJson(json.decode(str));

String weatherApiDtailsToJson(WeatherApiDtails data) =>
    json.encode(data.toJson());

class WeatherApiDtails {
  WeatherApiDtails({
    required this.lat,
    required this.lon,
  ...
  factory WeatherApiDtails.fromJson(Map<String, dynamic> json) =>
      WeatherApiDtails(
