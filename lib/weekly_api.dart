...
WeeklyApi weeklyApiFromJson(String str) => WeeklyApi.fromJson(json.decode(str));

String weeklyApiToJson(WeeklyApi data) => json.encode(data.toJson());
...
class WeeklyApi {
  ...
  factory WeeklyApi.fromJson(Map<String, dynamic> json) => WeeklyApi(
        ...
        minutely: json["minutely"] == null ? [] : List<Minutely>.from(
